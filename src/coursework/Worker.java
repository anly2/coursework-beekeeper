...
class Worker extends Bee
{
	 ...
	 * 
	 * @return Returns the Worker itself.
	 * @throws BeeDeath if the Worker died.
	 */
	public Worker anotherDay () throws BeeDeath
	{
		...
		hive.garden.getInterface().event("flowerTouched", flower1, this);
		hive.garden.getInterface().event("flowerTouched", flower2, this);
