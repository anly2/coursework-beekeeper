...
public abstract class Flower {
	 ...
	 * @return Returns the flower itself or null if it withered and died.
	 * @see #age
	 * @see #lifespan
	 * @see #grow()
	 * @see default.cfg
